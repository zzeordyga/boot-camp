...
function ClaudyaPage() {
    ...
    return (
        <div>
            <div style={{height: "calc(100vh - 4rem)", display:"flex", flexDirection:"column", justifyContent:"space-between", alignItems:"center"}}>
            ...
            <div style={{width: "100%", flexDirection: "row", flexWrap: "wrap", justifyContent:"center", gap:"1rem"}}>
                {images.map((image)=>{
            ...
            <div ref={popUp} style={{backgroundColor: "rgba(0, 0, 0, 0.8)", position: "fixed", top: "0", left: "0", right: "0", bottom: "0", alignContent: "center"}}>
                <div style={{width: "50%", height: "50%", padding: "4rem", display: "flex", flexDirection: "column", alignItems:"center", justifyContent: "space-between", backgroundColor: "aliceblue", justifySelf: "center"}}>
                    <h3>Message:</h3>
                    <p>{message}</p>
