...
function MyPage() {
  ...
  return (
    <div style={{ padding: "2rem", fontFamily: "Arial, sans-serif" }}>
      <h1>Yoko Hermanto - 2501967783</h1>
      <p ref={introRef}>
       Saya adalah mahasiswa jurusan Computer Science yang mempelajari dasar-dasar komputasi, pemrograman, dan pengembangan sistem perangkat lunak serta frontend.
      </p>
      <button
