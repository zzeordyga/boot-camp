...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body>
        <header className="bg-purple-300 font-medium text-white shadow p-4 w-full">
          <div className="flex flex-row items-center gap-6">
            <h3 className="font-bold flex items-center text-3xl">
              <svg xmlns="http://www.w3.org/2000/svg" className="mr-2" width={32} height={32} viewBox="0 0 24 24">
                <g fill="currentColor">
                  ...
                  <path d="M14.972 3c-1.459 0-2.647 1.388-2.916 3.113c-.29 1.867.574 3.65 2.174 3.867q.153.02.296.02c1.39 0 2.543-1.265 2.877-2.883l.041-.23c.29-1.867-.574-3.65-2.174-3.867a2 2 0 0 0-.298-.02M4.217 7c-.274 0-.544.054-.797.161c-1.426.615-1.767 2.562-1.078 4.335C2.905 12.947 4.052 14 5.283 14c.274 0 .544-.054.797-.161c1.426-.615 1.767-2.562 1.078-4.335C6.595 8.053 5.448 7 4.217 7"></path>
                </g>
              </svg>
              Dog Pedia
            </h3>
            <nav className="flex flex-row ml-auto items-center text-right font-medium">
              <Link href={'/'}>Home</Link>
